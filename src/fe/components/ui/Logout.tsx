...
export const Logout: React.FC<LogoutProps> = ({ onLogout }) => {
  return (
    <div className="fixed bottom-4 left-4 z-50 flex items-center bg-zinc-100  p-3 rounded-full shadow-lg cursor-pointer hover:bg-zinc-600 dark:bg-zinc-700 transition-all">
