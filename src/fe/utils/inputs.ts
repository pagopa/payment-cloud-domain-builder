    ...
    steps: {
        ...
        networking: {
            ...
            formFields: [
                ...
                { name: "Compute Vnet name": "compute_vnet_name", type: "text", placeholder: "e.g. ${local.prefix}-${var.env_short}-${var.location_short}-hub-vnet" },
                { name: "Compute Vnet RG name": "compute_vnet_rg", type: "text", placeholder: "e.g. ${local.prefix}-${var.env_short}-${var.location_short}-vnet-rg" },
                { name: "Data Vnet name": "data_vnet_name", type: "text", placeholder: "e.g. ${local.prefix}-${var.env_short}-${var.location_short}-spoke-data-vnet" },
                { name: "Data Vnet RG name": "data_vnet_rg", type: "text", placeholder: "e.g. ${local.prefix}-${var.env_short}-${var.location_short}-network-hub-spoke-rg" },
                { name: "Security Vnet name": "security_vnet_name", type: "text", placeholder: "e.g. ${local.prefix}-${var.env_short}-${var.location_short}-spoke-security-vnet" },
                { name: "Security Vnet RG name": "security_vnet_rg", type: "text", placeholder: "e.g. ${local.prefix}-${var.env_short}-${var.location_short}-network-hub-spoke-rg" },
                { name: "Streaming Vnet name": "streaming_vnet_name", type: "text", placeholder: "e.g. ${local.prefix}-${var.env_short}-${var.location_short}-spoke-streaming-vnet" },
                { name: "Streaming Vnet RG name": "streaming_vnet_rg", type: "text", placeholder: "e.g. ${local.prefix}-${var.env_short}-${var.location_short}-network-hub-spoke-rg" },
                { name: "Tools Vnet name": "tools_vnet_name", type: "text", placeholder: "e.g. ${local.prefix}-${var.env_short}-${var.location_short}-spoke-tools-vnet" },
                { name: "Tools Vnet RG name": "tools_vnet_rg", type: "text", placeholder: "e.g. ${local.prefix}-${var.env_short}-${var.location_short}-network-hub-spoke-rg" },
                { name: "Hub Vnet name": "hub_vnet_name", type: "text", placeholder: "e.g. ${local.prefix}-${var.env_short}-${var.location_short}-hub-vnet" },
                { name: "Hub Vnet RG name": "hub_vnet_rg", type: "text", placeholder: "e.g. ${local.prefix}-${var.env_short}-${var.location_short}-network-hub-spoke-rg" },
