...
export const templatesConfig = [
    {
        name: 'pagoPA hub-spoke ITN domain',
        description: 'Setup per dominio pagoPA basato in Italy North con risorse base, installato su reti hub-spoke. Include riferimenti APIM, AKS e CI/CD',
        icon: VscAzure,
        template: {
            "domain_name": "",
            "is_dev_public": true,
            ...
            "compute_vnet_name": "${local.product}-${var.location_short}-vnet",
            "compute_vnet_rg": "${local.product}-${var.location_short}-vnet-rg",
            "data_vnet_name": "${local.product}-${var.location_short}-spoke-data-vnet",
            "data_vnet_rg": "${local.product}-${var.location_short}-network-hub-spoke-rg",
            "security_vnet_name": "${local.product}-${var.location_short}-spoke-security-vnet",
            "security_vnet_rg": "${local.product}-${var.location_short}-network-hub-spoke-rg",
            "streaming_vnet_name": "${local.product}-${var.location_short}-spoke-streaming-vnet",
            "streaming_vnet_rg": "${local.product}-${var.location_short}-network-hub-spoke-rg",
            "tools_vnet_name": "${local.product}-${var.location_short}-spoke-tools-vnet",
            "tools_vnet_rg": "${local.product}-${var.location_short}-network-hub-spoke-rg",
            "hub_vnet_name": "${local.product}-${var.location_short}-hub-vnet",
            "hub_vnet_rg": "${local.product}-${var.location_short}-network-hub-spoke-rg",
