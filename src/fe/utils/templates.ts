...
export const templatesConfig = [
    {
        ...
        template: {
            ...
            "log_analytics_ws_rg_name": "${local.product}-${local.location_short}-core-monitor-rg",
            "monitor_rg_name": "${local.product}-${local.location_short}-core-monitor-rg",
            "monitor_action_group_slack_name": "SlackPagoPA",
            "monitor_action_group_email_name": "PagoPA",
            "monitor_action_group_opsgenie_name": "Opsgenie",
            "vnet_name": "${local.product}-${local.location_short}-vnet",
            "vnet_rg_name": "${local.product}-${local.location_short}-vnet-rg",
            "private_endpoint_subnet_name": "${local.product}-common-private-endpoint-snet",
            "private_endpoint_subnet_rg_name": "${local.product}-${local.location_short}-vnet-rg",
            "private_endpoint_subnet_vnet_name": "${local.product}-${local.location_short}-vnet",
    ...
    },
    {
        ...
        template: {
            ...
            "include_aks": false,
            "aks_name": "${local.prefix}-${var.env_short}-${local.location_short}-${local.project}-aks",
            "aks_rg_name": "${local.prefix}-${var.env_short}-${local.location_short}-${local.project}-aks-rg",
